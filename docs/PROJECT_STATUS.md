...
- [ ] M4-01~09 Voice（M4 进行中 7/9：M4-01~07 ✅）
- [ ] M4-01~09 Voice
- [ ] M5-01~08 Search + 治理
- [ ] M6-01~07 评测/安全/备份
- [ ] M7-01~06 Release
...
M4-07 完成后：进入 M4-08 Voice report 生成（REPORT_READY 终态后服务端生成学习报告——对错统计/薄弱概念/错题讲解，只读投影不作弊改判分结果；报告内容不含其他学生数据）。
