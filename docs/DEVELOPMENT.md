...
- 分支 `feature/m13-07-harmony-voice-providers`，基于 `origin/main@5ef95b29872bf5e50d839ef480f98093f8c195ec`（PR #62 merge commit（M13-06 状态回填），本地 git 可验证）；未 commit、未 push、未开 PR（文档时点）。
