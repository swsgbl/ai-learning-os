...
- [ ] 语音能力接入（M12-03 第一切片已在 `feature/m12-03-android-voice-flow` 完成——服务端权威语音陪练：创建/恢复会话、读题播报链、命令/意图作答、打断/暂停/跳过/结束、录音转写代理、全卷报告、trace 上报；本地已提交未 push 未开 PR；仍未跑模拟器/真机、未接真实 provider）
- [ ] 搜索接入
- [ ] 治理与发布链路接入
